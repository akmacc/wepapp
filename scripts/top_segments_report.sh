#!/bin/bash
###############################################################################
# Script Name : top_segments_report.sh
# Description : Generates an HTML report for Top 10 Largest Segments.
# Author      : Guna Ak
...
# Usage:
#   ./top_segments_report.sh <SID_PDB> [output_dir]
...
REPORT_FILENAME="top_segments_report_${ORACLE_SID}_${TODAY}.html"
